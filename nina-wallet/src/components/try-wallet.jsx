    ...
    <div className="max-w-6xl mx-auto px-4 py-3 flex items-center justify-between">
      ...
      <div className="flex items-center gap-3 text-sm">
        <div className="flex items-center gap-2 bg-gray-800 px-3 py-1 rounded-lg">
          <svg className="w-4 h-4 text-yellow-400" fill="currentColor" viewBox="0 0 24 24"><path d="M12 2L2 7l10 5 10-5-10-5z"/></svg>
          <div className="text-right">
            <div className="text-xs text-gray-300">Network</div>
            <div id="network" className="font-medium">BSC Mainnet</div>
          </div>
        </div>

        <div className="flex items-center gap-2">
          <button id="notifications" className="p-2 rounded hover:bg-gray-700" title="Notifications">🔔</button>
          <div className="text-sm text-gray-300 px-3 py-1 rounded-lg bg-gray-800 flex items-center gap-2">
            ...
            <button onclick="copyAddress()" className="text-gray-300 hover:text-white">📋</button>
            <button onclick="showQR()" className="text-gray-300 hover:text-white">🔲</button>
          </div>
          <button onclick="logout()" className="bg-purple-600 hover:bg-purple-700 px-3 py-1 rounded">Logout</button>
        </div>
      </div>
    </div>
  </nav>
    ...
    <section className="lg:col-span-2 space-y-6">
      ...
      <div className="bg-gradient-to-r from-purple-700 via-indigo-600 to-blue-600 rounded-2xl p-6 shadow-xl flex items-center justify-between">
        <div>
          ...
          <div className="text-sm text-white/80 mt-1">BNB: <span class="font-semibold">0.0000</span></div>

          <div className="mt-4 flex flex-wrap gap-3">
            <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg">📤 Send</button>
            <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg">📥 Receive</button>
            <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg">💱 Swap</button>
            <button className="flex items-center gap-2 bg-white/10 hover:bg-white/20 px-4 py-2 rounded-lg">➕ Add Token</button>
          </div>
        </div>
        <div className="hidden sm:block">
          <img src="wallet-illustration-light.png" alt="wallet" className="w-36 h-36 object-contain opacity-95" />
        </div>
      </div>
      ...
      <div className="bg-gray-800 rounded-xl p-4 shadow">
        <div className="flex items-center justify-between mb-3">
          ...
          <div className="text-sm text-gray-400">Total tokens: <span id="token-count">2</span></div>
        </div>
        ...
        <div className="divide-y divide-gray-700">
          ...
          <div className="flex items-center justify-between p-3">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <div className="text-xs text-gray-400">BNB • 18 decimals</div>
              </div>
            </div>
            <div className="text-right">
          ...
          <div className="flex items-center justify-between p-3">
            <div className="flex items-center gap-3">
              <img src="token-placeholder.png" alt="token" className="w-10 h-10 rounded-full bg-gray-700" />
              <div>
                <div className="font-medium">USDT (BEP-20)</div>
                <div className="text-xs text-gray-400">USDT • contract</div>
              </div>
            </div>
            <div className="text-right">
